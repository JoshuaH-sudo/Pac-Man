...
## 4. Core Game Loop and State Machine (yanlu 05.06 - 25.06.)
...
- [x] Preserve score and remaining lives across levels.
- [x] Return cleanly to the main menu after a finished run.
...
## 8. Level Progression (yanlu 24.06 - 25.06.)
- [x] Support at least 10 levels.
- [x] Use a fixed seed for level 1.
- [x] Use random generation for later levels.
- [x] Add a per-level time limit.
- [x] Decide and implement timeout behavior.
- [x] Move to the next level on completion.
- [x] End the game with victory after the final level.
...
## 11. Cheat Mode for Evaluation (yanlu 25.06. - 29.06)
- [x] Add a clear way to activate cheat mode.
- [x] Implement invincibility.
- [x] Implement level skip.
- [ ] Implement ghost freeze.
- [x] Implement extra lives.
